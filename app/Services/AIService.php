...
class AIService
{
    ...
    {
        return "На основе следующей заметки создай упражнение из 5-8 вопросов с ответами для самопроверки. Все вопросы и ответы должны быть на РУССКОМ языке.
...
{$noteContent}";
    ...
    {
        return "На основе следующей заметки придумай одну полноценную практическую задачу для закрепления темы заметки. Сама задача может стилистически быть связана с другими темами, но не должна требовать от решающего знаний в областях, не упомянутых в заметке. Условие и название должно быть написано на РУССКОМ языке.
...
{$noteContent}";
    ...
    {
        return "Ты — строгий, но справедливый преподаватель. Проверь решение студента. Проверка и соответвующие комментарии должны быть на РУССКОМ языке.
